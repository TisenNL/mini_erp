...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h5 class="card-title mb-0">Dados do Cupom</h5>
    </div>
    <div class="card-body">
        <?php echo form_open('cupons/create'); ?>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="desconto" name="desconto" step="0.01" min="0" required>
                        <small class="text-muted" id="desconto-info">Para percentual, use valores de 1 a 100.</small>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
