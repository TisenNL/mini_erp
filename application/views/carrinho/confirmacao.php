<div class="alert alert-success mb-4">
    <h4><i class="fas fa-check-circle"></i> Pedido Realizado com Sucesso!</h4>
    <p>Seu pedido #<?php echo $pedido->id; ?> foi confirmado e está sendo processado.</p>
    <p>Em breve você receberá um e-mail de confirmação com os detalhes do pedido.</p>
</div>
